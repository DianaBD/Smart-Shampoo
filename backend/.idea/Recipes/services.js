...
const add = async (name, clientId, goals, hairType, hairStructure, scalpMoisture,
  siliconFree, fragrance, shampooColor, conditionerColor, size, frequency,
  subscription) => {
...
const updateById = async (id, name, clientId, goals, hairType, hairStructure,
  scalpMoisture, siliconFree, fragrance, shampooColor, conditionerColor, size,
...
const deleteRecipesByUserId = async (id) => {
  try {
    const res = await Recipes.deleteMany({
      client: id
    });
